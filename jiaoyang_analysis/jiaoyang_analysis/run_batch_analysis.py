from jiaoyang_analysis.analysis import analyze_image, simple_analyze_image
from jiaoyang_analysis.config import data_dir, save_dir
from jiaoyang_analysis.import_data import batch_import_data
import pandas as pd

roi_prefix = 'dg_all_2_'  # Adjust this prefix based on your ROI naming convention
...
for img_package in data_package:
    ...
    result = simple_analyze_image(filename, img, roi)
